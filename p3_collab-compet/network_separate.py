...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, hidden_in_actor=256, hidden_out_actor=128):
        ...
        self.fc1 = nn.Linear(state_size, hidden_in_actor)
        self.fc2 = nn.Linear(hidden_in_actor, hidden_out_actor)
        self.fc3 = nn.Linear(hidden_out_actor, action_size)
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, hidden_in_critic=256, hidden_out_critic=128):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
        ...
        self.fcs1 = nn.Linear(critic_input_size, hidden_in_critic)
