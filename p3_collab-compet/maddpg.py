...
class MADDPG:
    ...
    def __init__(self, discount_factor=0.95, tau=0.02, state_space=24, action_space=2, num_agents=2):
    ...
    def update(self, samples, agent_number, logger):
        ...
        with torch.no_grad():
            q_next = agent.target_critic(target_critic_input, 1)
