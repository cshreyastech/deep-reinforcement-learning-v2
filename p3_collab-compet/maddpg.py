...
class MADDPG:
    def __init__(self, discount_factor=0.95, tau=0.02):
        ...
        self.maddpg_agent = [DDPGAgent(self.in_actor, self.out_actor, self.in_critic, self.out_critic),  
                             DDPGAgent(self.in_actor, self.out_actor, self.in_critic, self.out_critic)]
